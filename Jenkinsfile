pipeline {
    ...
    stages {
        ...
        stage('Build Docker Image') {
            steps {
                script {
                    sh "sudo docker build -t docker.io/abhishekkuradia/capstone-website:${env.BUILD_ID} ."
                    sh "sudo docker tag docker.io/abhishekkuradia/capstone-website:${env.BUILD_ID} docker.io/abhishekkuradia/capstone-website:latest"
                }
            }
        }
